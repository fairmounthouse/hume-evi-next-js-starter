    ...
    <footer className="py-12 w-full overflow-x-hidden" style={{backgroundColor: '#0A0B1E'}}>
      <div className="max-w-6xl mx-auto px-8">
        ...
        <div className="flex justify-center mt-8 gap-4">
          <Link href="#" className="w-10 h-10 bg-yellow-primary border-2 border-black rounded-lg flex items-center justify-center hover:bg-yellow-bright transition-colors">
