              ...
              {events.map((event, index) => {
                ...
                return (
                  <div key={index} className={cn("relative flex flex-col items-center", nodeSpacing, "min-w-[280px]")}>
                    {/* Timestamp */}
                    <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 text-xs font-semibold text-[#52525b] bg-white px-2 py-1 rounded border border-[#e4e4e7] whitespace-nowrap shadow-sm">
                      {event.timestamp}
                    </div>
                    ...
                    <div className="bg-white border border-[#e4e4e7] rounded-lg p-4 shadow-sm hover:shadow-md transition-all duration-200 min-w-[280px] max-w-[400px] group-hover:border-[#d4d4d8]">
        ...
        {events.map((event, index) => (
          <div key={index} className="flex items-start gap-4">
            ...
            <div className="flex flex-col items-center flex-shrink-0">
              <div className="text-xs font-medium text-[#71717a] mb-2 whitespace-nowrap">
                {event.timestamp}
              </div>
              <div className={cn(
            ...
            {/* Event Content */}
            <div className="flex-1 bg-white border border-[#e4e4e7] rounded-md p-4">
