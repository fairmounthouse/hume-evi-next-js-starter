...
export default function InterviewEndScreen({
  ...
  const getMomentType = (title: string): 'critical' | 'warning' | 'positive' => {
    ...
    if (titleLower.includes('positive') || titleLower.includes('strength') || titleLower.includes('good') || titleLower.includes('framework') || titleLower.includes('attempt')) {
      return 'positive';
    }
    if (titleLower.includes('warning') || titleLower.includes('concern') || titleLower.includes('avoidance') || titleLower.includes('vague')) {
      return 'warning';
    }
    return 'critical';
  };
